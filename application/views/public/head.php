...
<!-- 	FIN SVG -->
		...
		<nav id="nav" class="onlyDesktop">
			<div id="logo"><a href="<?php echo(base_url()); ?>"><img src="<?php echo(base_url('assets/public/img/logo-endemol.svg')); ?>"></img></a></div>
			<div id="menus">
				<a id="btnMenuHome" href="<?php echo(base_url()); ?>"><div class="menu">Home</div></a>
				<a href="<?php echo(base_url('nosotros')); ?>"><div class="menu">Nosotros</div></a>
				<a href="<?php echo(base_url('formatos')); ?>"><div class="menu">Formatos</div></a>
				<a href="<?php echo(base_url('cultura')); ?>"><div class="menu">Nuestra cultura</div></a>
			</div>
<!--			<div id="dir">
